<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="ComplaintsPortal.Web.Admin.Dashboard" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Overview of portal activity and metrics.</p>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Parse data injected from CodeBehind
            ...
            new Chart(ctxType, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Requests',
                        data: typeValues,
                        backgroundColor: '#4361ee', // primary-portal
                        borderRadius: 4
                    }]
                },
                options: {
